...
#import "YouboraBrightcoveAdapter/YBBrightcoveAdAdapter.h"
...
@property (strong, nonatomic) YBPlugin *plugin;
@end
...
- (void)viewDidLoad {
    ...
    [self.plugin setAdapter:[[YBBrightcoveAdapter alloc] initWithPlayer:self.controller]];
    [self.plugin setAdsAdapter:[[YBBrightcoveAdAdapter alloc] initWithPlayer:self.controller]];
